"""
Django settings for czarcie project.
...
CONF_COMMON_FILE = os.path.join(CONF_DIR, 'settings_common.json')
...
WSGI_APPLICATION = 'czarcie.wsgi.application'
